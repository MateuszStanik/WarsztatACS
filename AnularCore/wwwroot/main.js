...
/* harmony import */ var _shared_layout_header_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./shared/layout/header.component */ "./src/app/shared/layout/header.component.ts");
/* harmony import */ var _shared_layout_footer_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./shared/layout/footer.component */ "./src/app/shared/layout/footer.component.ts");
...
/* harmony import */ var _clients_clients_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./clients/clients.component */ "./src/app/clients/clients.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["NgModule"])({
            declarations: [
                ...
                _shared_layout_header_component__WEBPACK_IMPORTED_MODULE_15__["HeaderComponent"],
                _shared_layout_footer_component__WEBPACK_IMPORTED_MODULE_16__["FooterComponent"],
                _orders_orders_component__WEBPACK_IMPORTED_MODULE_17__["OrdersComponent"],
                _clients_clients_component__WEBPACK_IMPORTED_MODULE_18__["ClientsComponent"],
            ],
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forRoot([
                    ...
                    { path: 'orders', component: _orders_orders_component__WEBPACK_IMPORTED_MODULE_17__["OrdersComponent"] },
                    { path: 'clients', component: _clients_clients_component__WEBPACK_IMPORTED_MODULE_18__["ClientsComponent"] },
                    { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_13__["LoginComponent"] },
                    { path: 'customers', component: _customers_customers_component__WEBPACK_IMPORTED_MODULE_14__["CustomersComponent"], canActivate: [_guards_auth_guard_service__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]] },
                ]),
...
var ClientsComponent = /** @class */ (function () {
    ...
    ClientsComponent.prototype.onCustomAction = function (event, template) {
        ...
        this.getClientById(event.data.clinetId).then(function (data) {
            console.log(data);
    ...
    ClientsComponent.prototype.getData = function () {
        ...
        var promis = new Promise(function (resolve, reject) {
            var apiURL = "https://localhost:44335/api/client/GetCompanyCustomers";
    ...
    ClientsComponent.prototype.getClientById = function (id) {
        ...
        var promis = new Promise(function (resolve, reject) {
            var apiURL = "https://localhost:44335/api/client/GetClient";
            _this.http.get(apiURL, {
                headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({
                    "Content-Type": "application/json",
                }),
...
var CustomersComponent = /** @class */ (function () {
    ...
    CustomersComponent.prototype.ngOnInit = function () {
        ...
        this.http.get("https://localhost:44335/api/customers", {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function (form) {
        ...
        this.http.post("https://localhost:44335/api/auth/login", credentials, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({
                "Content-Type": "application/json"
            })
        }).subscribe(function (response) {
...
var OrdersComponent = /** @class */ (function () {
    ...
    OrdersComponent.prototype.ngOnInit = function () {
        var _this = this;
        var token = localStorage.getItem("jwt");
        this.http.get("https://localhost:44335/api/client/get", {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Authorization": "Bearer " + token,
                "assets-Type": "application/json"
            })
