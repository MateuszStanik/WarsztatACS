...
/* harmony import */ var _cars_cars_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./cars/cars.component */ "./src/app/cars/cars.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["NgModule"])({
            declarations: [
                ...
                _cars_cars_component__WEBPACK_IMPORTED_MODULE_21__["CarsComponent"]
            ],
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forRoot([
                    ...
                    { path: 'cars/:id', component: _cars_cars_component__WEBPACK_IMPORTED_MODULE_21__["CarsComponent"] },
...
module.exports = "\r\n<div class=\"row\">\r\n  <div class=\"col-lg-6\">\r\n    <div class=\"form-group\">\r\n      <label>Marka</label>\r\n      <input name=\"Brand\" id=\"Brand\" [(ngModel)]=\"car.Brand\" class=\"form-control\">\r\n    </div>\r\n  </div>\r\n  <div class=\"col-lg-6\">\r\n    <div class=\"form-group\">\r\n      <label>Model</label>\r\n      <input name=\"Model\" id=\"Model\" [(ngModel)]=\"car.Model\" class=\"form-control\">\r\n    </div>\r\n  </div>\r\n</div>\r\n<div class=\"row\">\r\n  <div class=\"col-lg-6\">\r\n    <div class=\"form-group\">\r\n      <label>Rocznik</label>\r\n      <input name=\"Year\" id=\"Year\" [(ngModel)]=\"car.Year\" class=\"form-control\">\r\n    </div>\r\n  </div>\r\n  <div class=\"col-lg-6\">\r\n    <div class=\"form-group\">\r\n      <label>Rodzaj silnika</label>\r\n      <input name=\"EngineType\" id=\"EngineType\" [(ngModel)]=\"car.EngineType\" class=\"form-control\">\r\n    </div>\r\n  </div>\r\n</div>\r\n<div class=\"row\">\r\n  <div class=\"col-lg-6\">\r\n    <div class=\"form-group\">\r\n      <label>Pojemność</label>\r\n      <input name=\"Brand\" id=\"Brand\" [(ngModel)]=\"car.Capacity\" class=\"form-control\">\r\n    </div>\r\n  </div>\r\n  <div class=\"col-lg-6\">\r\n    <div class=\"form-group\">\r\n      <label>Moc</label>\r\n      <input name=\"Model\" id=\"Model\" [(ngModel)]=\"car.Power\" class=\"form-control\">\r\n    </div>\r\n  </div>\r\n</div>\r\n<button type=\"button\" class=\"btn btn-primary form-control\" >Dodaj nowe zlecenie dla samochodu</button>\r\n<button type=\"button\" class=\"btn btn-primary form-control\">Historia napraw samochodu</button>\r\n"
...
/*!****************************************!*\
  !*** ./src/app/cars/cars.component.ts ***!
  \****************************************/
/*! exports provided: CarsComponent, Car */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CarsComponent = /** @class */ (function () {
    function CarsComponent(route, router, http) {
        this.route = route;
        this.router = router;
        this.http = http;
    ...
    CarsComponent.prototype.ngOnInit = function () {
        ...
        this.getCarById(this.id).then(function (data) {
            _this.car = new Car(data.clientId, data.brand, data.model, data.year, data.engineType, data.capacity, data.power, data.carIdentificator);
    ...
    CarsComponent.prototype.getCarById = function (id) {
        ...
        var promis = new Promise(function (resolve, reject) {
            var apiURL = "http://localhost:1405/api/car/GetCarDetailsById";
    ...
    CarsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], CarsComponent);
...
var ClientsComponent = /** @class */ (function () {
    ...
    ClientsComponent.prototype.getData = function () {
        var _this = this;
        var promis = new Promise(function (resolve, reject) {
            var apiURL = "http://localhost:1405/api/client/GetCompanyCustomers";
            _this.http.get(apiURL)
                .toPromise()
                .then(function (res) {
                console.log(res);
    ...
    ClientsComponent.prototype.getClientById = function (id) {
        ...
        var promis = new Promise(function (resolve, reject) {
            var apiURL = "http://localhost:1405/api/client/GetClient";
            _this.http.get(apiURL, {
...
var ClientsDetailsComponent = /** @class */ (function () {
    function ClientsDetailsComponent(route, router, http, modalService) {
        this.route = route;
        this.router = router;
        this.http = http;
        this.modalService = modalService;
    ...
    ClientsDetailsComponent.prototype.onDeleteConfirm = function (event) {
        var _this = this;
        console.log(event);
        var url = "http://localhost:1405/api/car/DeleteCar";
    ...
    ClientsDetailsComponent.prototype.onNewOrder = function (event) {
        console.log(event.data.clinetId);
    ...
    ClientsDetailsComponent.prototype.getCars = function (id) {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set("id", id.toString());
        var promis = new Promise(function (resolve, reject) {
            var apiURL = "http://localhost:1405/api/car/GetCarsForClient";
            _this.http.get(apiURL, {
                headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                    "Content-Type": "application/json",
                }),
    ...
    ClientsDetailsComponent.prototype.addCar = function () {
        var _this = this;
        var url = "http://localhost:1405/api/car/AddCarForClient";
        var body = {
            ClientId: this.id,
    ...
    ClientsDetailsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_3__["BsModalService"]])
